...
## 🚀 Getting Started
Follow these easy steps to get started. You don’t need to be a programmer. Just follow along.

### 1. System Requirements
To run the Media Catalogue app, you will need:
...
### 5. Running the App
Once the app is installed, you can open it like any other application on your system.

- **Windows:** Search for “Media Catalogue” in the Start menu.
- **macOS:** Open the Applications folder and find “Media Catalogue”.
- **Linux:** Use the file browser to locate “Media Catalogue” and double-click to run it.

### 6. Using the Media Catalogue
Here’s how you can use the app:
- Start the application.
- Choose 'Add Media' to catalog your movies, shows, or music.
- Use the search feature to find your entries quickly.
- Modify or delete entries as needed. 

The design is simple, making it user-friendly for everyone.
...
- Open an issue on GitHub for any bugs or suggestions.
